...
require('lazy').setup({
  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    ...
    opts = {
      ...
      -- TODO: How do I toggle this in code?
      word_diff = false,
    },
  },
  ...
  -- TS specific I hear it's just better
  {
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      -- can't add 'gdscript' to servers it's not in Mason
      local gdscript_config = {
        capabilities = capabilities,
        settings = {},
      }
      if vim.fn.has 'win32' == 1 then
        -- requires nmap to be installed on machine
        gdscript_config['cwd'] = { 'ncat', 'localhost', os.getenv 'GDScript_Port' or '6005' }
      end
...
local files_set_cwd = function()
  ...
  vim.print(string.format('Moving to ', cur_entry_path))
end
